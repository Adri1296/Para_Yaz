...
var lyricsData = [
  { text: "Cada vez que me levanto", time: 20 },
  { text: "Y veo que a mi lado estás", time: 21 },
  { text: "Me siento renovado", time: 22 },
  { text: "Y me siento aniquilado", time: 23 },
  { text: "Aniquilado si no estás", time: 24 },
  { text: "Tu controlas toda mi verdad", time: 25 },
  ...
  { text: "De un rojo atardecer", time: 35 },
