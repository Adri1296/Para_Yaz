...
var lyricsData = [
  ...
  { text: "Aniquilado si no estás", time: 20 },
  { text: "Tu controlas toda mi verdad", time: 23 },
  { text: "Y todo lo que está de más", time: 25 },
  { text: "Tus ojos me llevan lentamente al sol", time: 27 },
  { text: "Y tu boca me habla del amor y el corazon", time: 29 },
  { text: "Tu piel tiene el color", time: 30 },
