...
var lyricsData = [
  ...
  { text: "Y veo que a mi lado estás", time: 8 },
  { text: "Me siento renovado", time: 10 },
  { text: "Y me siento aniquilado", time: 12 },
  { text: "Aniquilado si no estás", time: 14 },
  { text: "Tu controlas toda mi verdad", time: 15 },
  { text: "Y todo lo que está de más", time: 18 },
  ...
  { text: "Y es por ti", time:  },
  { text: "Que calma mi dolor", time: },
  { text: "Cada vez que me levanto", time:  },
  { text: "Y veo que a mi lado estás", time:  },
  { text: "Cada vez que me levanto", time:  },
  { text: "Cada vez que me levanto", time:  },
  { text: "Cada vez que me levanto", time:  },
  { text: "Cada vez que me levanto", time:  },
